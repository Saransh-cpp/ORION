...
| Variable            | Default                                     | Used By            | Description                      |
| ------------------- | ------------------------------------------- | ------------------ | -------------------------------- |
| `ORION_GGUF_PATH`   | `/home/saransh/ORION/orion-q4_k_m.gguf`     | VlmInferenceEngine | Q4_K_M quantized text model      |
| `ORION_MMPROJ_PATH` | `/home/saransh/ORION/orion-mmproj-f16.gguf` | VlmInferenceEngine | FP16 multimodal vision projector |

## Storage Directories

| Variable                   | Default                           | Used By                   | Description                                               |
| -------------------------- | --------------------------------- | ------------------------- | --------------------------------------------------------- |
| `ORION_MEDIUM_STORAGE_DIR` | `/media/sd/orion/medium/`         | TriageRouter, EventAction | MEDIUM image storage. Path + filename must be < 100 chars |
| `ORION_DOWNLINK_QUEUE_DIR` | `/media/sd/orion/downlink_queue/` | GroundCommsDriver         | HIGH frame disk queue (outside comm window)               |
...
export ORION_GGUF_PATH=/home/saransh/ORION/orion-q4_k_m.gguf
export ORION_MMPROJ_PATH=/home/saransh/ORION/orion-mmproj-f16.gguf
export ORION_MEDIUM_STORAGE_DIR=/home/saransh/ORION/orion_medium/
export ORION_DOWNLINK_QUEUE_DIR=/home/saransh/ORION/orion_downlink_queue/
